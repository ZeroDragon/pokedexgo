...
},{"./support/grader":3,"./support/levelUpData":4,"./support/pokedex":5,"underscore":2}],2:[function(require,module,exports){
//     Underscore.js 1.8.3
...
function determineGrade(values) {
	...
	return {
		minGrade, maxGrade, averageGrade,
		explanation : `Between ${maxGrade.preciseLetter} and ${minGrade.preciseLetter}`
	}
}
